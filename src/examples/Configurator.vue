    ...
    <div class="shadow-lg card">
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <div class="d-flex gap-2">
          <button id="btn-white" class="btn w-100 px-3 mb-2" :class="sidebarType === 'bg-white'
            ? 'bg-gradient-success'
            : 'btn-outline-success'
            " @click="setSidebarType('bg-white')">
            White
          </button>
          <button id="btn-dark" class="btn w-100 px-3 mb-2" :class="sidebarType === 'bg-default'
            ? 'bg-gradient-success'
            : 'btn-outline-success'
        ...
        <div class="mt-3 d-flex">
          ...
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input class="mt-1 form-check-input ms-auto" type="checkbox" id="navbarFixed" :checked="isNavFixed"
              @click="navbarFixed" />
          </div>
        </div>
